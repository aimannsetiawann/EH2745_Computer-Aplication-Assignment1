...
public class GUINEW {
	...
	//public void GUICall() throws Exception
	...
	//Tablee calltable = new Tablee();
	//calltable.SimpleTableDemo();
	}
	...
	JButton btnInputSshFile = new JButton("Input SSH FIle");
	btnInputSshFile.addActionListener(new ActionListener() {
	...
	//System.out.println(fileChoose.getSelectedFile());
	
	SSH=fileChoose.getSelectedFile();
	...
	btnInputSshFile.setBounds(21, 173, 403, 23);
	frame.getContentPane().add(btnInputSshFile);
	
	
	
	
	JButton btnNewButton = new JButton("Input EQ File");
	...
	fileChoose.setMultiSelectionEnabled(true);
	openFile2 = fileChoose.showOpenDialog(null);
	
	//System.out.println(fileChoose.getSelectedFile());
	
	EQ=fileChoose.getSelectedFile();
	...
	btnNewButton.setBounds(21, 139, 403, 23);
	frame.getContentPane().add(btnNewButton);
	
	JButton btnRunProgram = new JButton("RUN PROGRAM");
	btnRunProgram.setBounds(282, 115, 51, -9);
	frame.getContentPane().add(btnRunProgram);
	
	JButton btnRunProgram_1 = new JButton("EXECUTE (PARSING, CREATE DATABASE, Y BUS TABLE)");
	btnRunProgram_1.addActionListener(new ActionListener() {
	public void actionPerformed(ActionEvent e) {
	...
	//File EQXMLFile=new File ("C:\\MicroGridTestConfiguration_T1_BE_EQ_V2.xml");
	//File SSHXMLFile=new File ("C:\\MicroGridTestConfiguration_T1_BE_SSH_V2.xml");
	
	
	DocumentBuilderFactory dbFactory= DocumentBuilderFactory.newInstance();
	DocumentBuilder dBuilder= dbFactory.newDocumentBuilder();
	Document doc = dBuilder.parse(EQ);
	...
	String ad=Ybus[0][3].StringForm(Ybus[0][3]);
	String ae=Ybus[0][4].StringForm(Ybus[0][4]);
	String ba=Ybus[1][0].StringForm(Ybus[1][0]);
	String bb=Ybus[1][1].StringForm(Ybus[1][1]);
	String bc=Ybus[1][2].StringForm(Ybus[1][2]);
	String bd=Ybus[1][3].StringForm(Ybus[1][3]);
	String be=Ybus[1][4].StringForm(Ybus[1][4]);
	String ca=Ybus[2][0].StringForm(Ybus[2][0]);
	String cb=Ybus[2][1].StringForm(Ybus[2][1]);
	String cc=Ybus[2][2].StringForm(Ybus[2][2]);
	String cd=Ybus[2][3].StringForm(Ybus[2][3]);
	String ce=Ybus[2][4].StringForm(Ybus[2][4]);
	String da=Ybus[3][0].StringForm(Ybus[3][0]);
	String db=Ybus[3][1].StringForm(Ybus[3][1]);
	String dc=Ybus[3][2].StringForm(Ybus[3][2]);
	String dd=Ybus[3][3].StringForm(Ybus[3][3]);
	String de=Ybus[3][4].StringForm(Ybus[3][4]);
	String ea=Ybus[4][0].StringForm(Ybus[4][0]);
	String eb=Ybus[4][1].StringForm(Ybus[4][1]);
	String ec=Ybus[4][2].StringForm(Ybus[4][2]);
	String ed=Ybus[4][3].StringForm(Ybus[4][3]);
	String ee=Ybus[4][4].StringForm(Ybus[4][4]);
	
	String[] columnNames = {"YBUS MATRIX", "1", "2", "3", "4", "5"};
	String[][] data = {
	{"1", aa, ab, ac, ad, ae},
	{"2", ba, bb, bc, dd, be},
	{"3", ca, cb, cc, cd, ce},
	...
	Table gui = new Table (data, columnNames);
	...
	btnRunProgram_1.setFont(new Font("Tahoma", Font.BOLD, 13));
	btnRunProgram_1.setForeground(Color.RED);
	btnRunProgram_1.setBounds(21, 207, 403, 29);
	frame.getContentPane().add(btnRunProgram_1);
	
	JLabel lblUsername = new JLabel("USERNAME");
	lblUsername.setBounds(21, 72, 71, 23);
	...
	username.setBounds(92, 73, 125, 20);
	frame.getContentPane().add(username);
	username.setColumns(10);
	
	JLabel lblPassword = new JLabel("PASSWORD");
	lblPassword.setBounds(21, 106, 77, 23);
	frame.getContentPane().add(lblPassword);
	
	passwordField = new JPasswordField();
	passwordField.setBounds(92, 106, 125, 21);
	frame.getContentPane().add(passwordField);
	
	JLabel lblEh = new JLabel("EH 2745 - Computer Application for Power System");
	lblEh.setForeground(Color.BLUE);
	lblEh.setFont(new Font("Adobe Caslon Pro", Font.BOLD, 16));
	lblEh.setBounds(40, 21, 351, 40);
	frame.getContentPane().add(lblEh);
	
	JButton CHECK = new JButton("CHECK USERNAME & PASSWORD");
	...
	if (uname.equals("root") &&  pass.equals("28Des94"))
	{
	JOptionPane.showMessageDialog(frame, "ALRIGHT");
	}
	else
	{
	JOptionPane.showMessageDialog(frame, "TET TOT WRONG");
	}
